    ...
    def forward(
        ...
        if type(encoder_memory) == tuple:
            ...
            if self.cif:
                ...
                padding_mask_tensor = memory_key_padding_mask
                ...
                am_output = self.lm_decoder[0](cif_input, target_lengths)['cif_out']
                #print(am_output['cif_out'].size())
            ...
            alignment_lengths = torch.sum(lm_input["attention_mask"], 1)
            if self.cif:
                alignment_target = alignment_lengths
            else:
